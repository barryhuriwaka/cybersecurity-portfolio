...
| 002 |  (https://github.com/barryhuriwaka/case-study-02-bec)  | Header analysis, URL detonation, mailbox audit, MFA fatigue detection, Suspicious inbox rule detection, Threat actor impersonation analysis, Identity‑based threat investigation, Financial fraud prevention workflow |
