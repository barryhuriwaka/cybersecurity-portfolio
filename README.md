...
|--------|------------------------------------------------------------------------|--------------------------------------------------------|
| 001    | [Suspicious Login Activity — Microsoft 365](https://github.com/barryhuriwaka/soc-investigation-suspicious-logins) | KQL, Azure AD, Identity Protection, IR workflow    | 002    | Case Study 002 — Business Email Compromise (BEC)
[View Case Study →](https://github.com/barryhuriwaka/case-study-02-bec)  | Header analysis, URL detonation, mailbox audit, MFA fatigue detection, Suspicious inbox rule detection, Threat actor impersonation analysis, Identity‑based threat investigation, Financial fraud prevention workflow |
